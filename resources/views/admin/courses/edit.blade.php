...
@section('content')
    ...
    <h4 class="py-3 mb-4">
        ...
        <a href="{{route('admin.courses.index')}}">
            <span class="text-muted fw-light">{{trans('dashboard.courses')}}/</span>
        </a>
        {{ trans('dashboard.edit_course') }}
    </h4>
    <div class="col-xxl">
                ...
                <form action="{{route('admin.courses.update',$course->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            <label for="name" class="form-label">{{ trans('dashboard.course_name_ar') }}</label>
                            <input dir="rtl" type="text" name="name" value="{{ $course->getTranslation('name','ar') }}" class="form-control"/>
                            @error('name')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                        <div class="col-6 mb-3">
                            <label for="name" class="form-label">{{ trans('dashboard.course_name_en') }}</label>
                            <input type="text" name="name_en" value="{{ $course->getTranslation('name','en') }}" class="form-control"/>
                            @error('name')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" id="publish_date" name="publish_date" value="{{ $course->publish_date }}" class="form-control">
                            @error('publish_date')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <input dir="rtl" type="text" name="content_home" value="{{ $course->getTranslation('content_home','ar') }}" class="form-control"/>
                            @error('content_home')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" name="content_home_en" value="{{ $course->getTranslation('content_home','en') }}" class="form-control"/>
                            @error('content_home')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <textarea rows="5" name="content" id="ckeditor1" class="form-control">{!! $course->getTranslation('content','ar') !!}</textarea>
                            @error('content')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <textarea rows="5" name="content_en" id="ckeditor2" class="form-control">{!! $course->getTranslation('content','en') !!}</textarea>
                            @error('content')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        @if (!empty($course->image->file_name))
                            <img src="{{ asset('Files/image/Courses/'.$course->image->file_name) }}" style="width: 100px;height:100px;padding-top:10px">
                        @endif
                        </div>

                        <div class="col-12 mb-3">
                            <label for="keywords" class="form-label">{{ trans('dashboard.keywords') }}</label>
                            <input type="text" name="keywords" value="{{ $course->keywords  }}" class="form-control"/>
                            @error('keywords')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
